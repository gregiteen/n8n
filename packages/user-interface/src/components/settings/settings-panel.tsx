...
import { Save, Palette, Bell, Shield, User, Key, ArrowLeft } from 'lucide-react';
...
export function SettingsPanel() {
  ...
  const [activeSection, setActiveSection] = React.useState<'main' | 'apiKeys'>('main');
  ...
  // Render the API Keys management section
  ...
  // Otherwise, render the main settings panel
  return (
    <div className="space-y-6">
